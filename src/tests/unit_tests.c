...
START_TEST(s21_create_matrix_2) {
  ...
  ck_assert_int_eq(s21_create_matrix(5, 5, NULL), ERR_INCORRECT_MATRIX);
}
END_TEST
...
START_TEST(s21_create_matrix_3) {
  ...
  matrix_t A = {};
  ck_assert_int_eq(s21_create_matrix(5, 0, &A), ERR_INCORRECT_MATRIX);
}
END_TEST
...
START_TEST(s21_remove_matrix_3) {
  // failure handle ERR_INCORRECT_MATRIX structure
  matrix_t A = {};
  s21_remove_matrix(&A);
  ck_assert_int_eq(1, 1);
}
...
START_TEST(s21_eq_matrix_5) {
  // failure with ERR_INCORRECT_MATRIX
  matrix_t A = {};
  matrix_t B = {};
  s21_create_matrix(5, 5, &A);
  ck_assert_int_eq(s21_eq_matrix(&A, &B), FAILURE);
...
START_TEST(s21_sum_matrix_1) {
  ...
  matrix_t A = {};
  matrix_t B = {};
  ck_assert_int_eq(s21_sum_matrix(&A, &B, NULL), ERR_INCORRECT_MATRIX);
}
END_TEST
...
START_TEST(s21_sum_matrix_2) {
  ...
  s21_create_matrix(5, 5, &B);
  ck_assert_int_eq(s21_sum_matrix(&A, &B, &result), ERR_CALCULATION);
  s21_remove_matrix(&A);
  s21_remove_matrix(&B);
}
END_TEST
...
START_TEST(s21_sub_matrix_1) {
  ...
  matrix_t A = {};
  matrix_t B = {};
  ck_assert_int_eq(s21_sub_matrix(&A, &B, NULL), ERR_INCORRECT_MATRIX);
}
END_TEST
...
START_TEST(s21_sub_matrix_2) {
  ...
  s21_create_matrix(4, 4, &A);
  s21_create_matrix(5, 5, &B);
  ck_assert_int_eq(s21_sub_matrix(&A, &B, &result), ERR_CALCULATION);
  s21_remove_matrix(&A);
  s21_remove_matrix(&B);
}
END_TEST
...
START_TEST(s21_mult_number_1) {
  ...
  s21_create_matrix(3, 3, &A);
  s21_initialize_matrix(&A, 1, 1);
  ck_assert_int_eq(s21_mult_number(&A, number, NULL), ERR_INCORRECT_MATRIX);
  s21_remove_matrix(&A);
}
END_TEST
...
START_TEST(s21_mult_number_2) {
  ...
  s21_create_matrix(3, 3, &A);
  s21_initialize_matrix(&A, 1, 1);
  ck_assert_int_eq(s21_mult_number(&A, number, &result), ERR_CALCULATION);
  s21_remove_matrix(&A);
}
END_TEST
...
START_TEST(s21_mult_matrix_1) {
  ...
  s21_create_matrix(3, 3, &A);
  s21_initialize_matrix(&A, 1, 1);
  ck_assert_int_eq(s21_mult_matrix(&A, NULL, NULL), ERR_INCORRECT_MATRIX);
  s21_remove_matrix(&A);
}
END_TEST
...
START_TEST(s21_mult_matrix_2) {
  ...
  ck_assert_int_eq(s21_mult_matrix(&A, &B, &result), ERR_CALCULATION);
  s21_remove_matrix(&A);
  s21_remove_matrix(&B);
  s21_remove_matrix(&result);
}
...
START_TEST(s21_transpose_1) {
  ...
  matrix_t A = {};
  matrix_t result = {};
  ck_assert_int_eq(s21_transpose(&A, &result), ERR_INCORRECT_MATRIX);
}
END_TEST
...
START_TEST(s21_calc_complements_1) {
  ...
  matrix_t A = {};
  s21_create_matrix(3, 3, &A);
  ck_assert_int_eq(s21_calc_complements(&A, NULL), ERR_INCORRECT_MATRIX);
  s21_remove_matrix(&A);
}
END_TEST
...
START_TEST(s21_calc_complements_2) {
  ...
  ck_assert_int_eq(s21_calc_complements(&A, &result), ERR_CALCULATION);
  s21_remove_matrix(&A);
}
END_TEST
...
START_TEST(s21_determinant_1) {
  ...
  matrix_t A = {};
  double det = 0;
  ck_assert_int_eq(s21_determinant(&A, &det), ERR_INCORRECT_MATRIX);
}
END_TEST
...
START_TEST(s21_determinant_2) {
  ...
  s21_create_matrix(3, 2, &A);
  s21_initialize_matrix(&A, 1, 1);
  ck_assert_int_eq(s21_determinant(&A, &det), ERR_CALCULATION);
  s21_remove_matrix(&A);
}
END_TEST
